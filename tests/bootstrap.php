 ...
 * (host-style consumption), reuse the sibling platform's autoload and map
 * this package's PSR-4 roots manually.
 */
...
if (is_file($packageAutoload)) {
    ...
    $candidates = [
        ...
        dirname(__DIR__, 2).'/telegram-bot-platform/vendor/autoload.php',
    ];
